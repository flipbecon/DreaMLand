...
import dwyanewade.squeezenet.SqueezeNcnn;
...
public class MainActivity extends Activity
{
    ...
    private void initSqueezeNcnn() throws IOException
    {
        ...
        {
            InputStream assetsInputStream = getAssets().open("deploy_inference.param");
        ...
        {
            InputStream assetsInputStream = getAssets().open("deploy_inference.bin");
            int available = assetsInputStream.available();
